...
soot.PAH_growth_model.K_REACT_prefactor = 1.0/50.0;
soot.PAH_growth_model.K_PAH_ADS_prefactor = 0.5;
### Setting precursors
...
soot_columns += ["soot_mass[g/g]", "volume_fraction", "SSA",
...
soot_data += [states.total_mass, states.volume_fraction, states.SSA,
              states.total_carbon_mass, states.soot_carbon_mass/states.total_carbon_mass[0],
